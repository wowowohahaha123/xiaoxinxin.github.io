						...
						foreach ( $shop_isle_advantages_decoded as $shop_isle_advantage ) :
							...
							if ( ! empty( $shop_isle_advantage->text ) ) :
								...
								if ( function_exists( 'icl_t' ) && ! empty( $shop_isle_advantage->id ) ) {
									...
									echo '<h3 class="features-title font-alt">' . wp_kses_post( $shop_isle_advantage_text ) . '</h3>';
								} else {
									echo '<h3 class="features-title font-alt">' . wp_kses_post( $shop_isle_advantage->text ) . '</h3>';
								}
									endif;
